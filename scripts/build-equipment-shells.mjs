...
<head>
  ...
  <link rel="stylesheet" href="../equipment-detail.min.css?v=1.5">
  ...
  <script defer src="../catalog-detail-runtime.min.js?v=1.0"></script>
  ...
  <main class="equipment-detail-page" data-equipment-slug="${slug}">
    <div class="equipment-detail-shell">
      <div class="equipment-detail-topbar">
        <a class="equipment-detail-back" href="../gallery.html"><span class="material-symbols-outlined" aria-hidden="true">arrow_forward</span><span>بازگشت به کاتالوگ</span></a>
