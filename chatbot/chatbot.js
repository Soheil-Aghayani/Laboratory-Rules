  ...
  function createChatbotUI() {
    ...
    fab.innerHTML = `
      <svg class="chatbot-fab-icon" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <title>حباب گفت‌وگوی دستیار هوشمند آزمایشگاه</title>
        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20.5 11.5c0 4.142-3.806 7.5-8.5 7.5a9.9 9.9 0 0 1-3.8-.75L4 20l.77-3.06A7.4 7.4 0 0 1 3.5 11.5C3.5 7.358 7.306 4 12 4s8.5 3.358 8.5 7.5Z" />
        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m8 14.5 1.5-5 1.5 5m-2.5-1.5h2m3-3.5v5" />
      </svg>
    `;
...
${chem.firstAid.inhalation ? `- استنشاق: ${chem.firstAid.inhalation}\n` : ''}اقدام اضطراری نشت: ${chem.spillAction}`;
  ...
  const qaAutocompleteIconSvg = `
    <svg class="autocomplete-icon autocomplete-icon-svg" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <title>bookmark-square-minimalistic-linear</title>
  ...
  function updateAutocomplete() {
    ...
    suggestionMatches.forEach((match, index) => {
      ...
      const iconMarkup = match.type === 'chemical'
        ? '<span class="material-symbols-outlined autocomplete-icon" aria-hidden="true">science</span>'
        : qaAutocompleteIconSvg;
      item.innerHTML = `
        ${iconMarkup}
